...
- [ ] 执行 `freestanding` 依赖扫描（`zig build -Dtarget=bpfel-freestanding` 针对 core 目录）
- [ ] 在 CI 中增加 SBF compile-only gate
- [ ] 若扫描通过，更新 `docs/40-phase4-planning.md` 的 core-types 共享结论为 "已验证"
